...
class Database {
     ...
     * @return void 
     */
    function __construct($query, $escape)
    {
        //Config::load('test.database');
     ...
     * @return	\Database
     */
    public static function query($query, $escape = true)
    {        
        return new self($query, $escape);
    }
     ...
     * @return \Database 
     */
    public function execute($a = true)
    {
